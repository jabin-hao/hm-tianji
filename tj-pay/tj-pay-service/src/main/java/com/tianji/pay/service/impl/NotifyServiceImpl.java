...
public class NotifyServiceImpl implements INotifyService {
    ...
    public void handleWxPayRefundNotify(NotificationRequest request) {
        ...
        // 3.幂等性校验
        RefundOrder refundOrder = checkRefundData(refundOrderNo, status);
    ...
    private RefundOrder checkRefundData(Long refundOrderNo, RefundStatus status) {
        // 1.查询退款单
        ...
        boolean success = refundOrderService.lambdaUpdate()
                ...
                .set(StringUtils.isNotBlank(null), RefundOrder::getRefundChannel, null)
