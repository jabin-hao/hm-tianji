...
public interface PayClient {
     ...
     * 根据业务端订单 id查询支付结果
     *
     * @param bizOrderId 业务订单 id
     * @return 支付结果
     */
    @GetMapping("/pay-orders/{bizOrderId}/status")
    PayResultDTO queryPayResult(@PathVariable Long bizOrderId);
     ...
     * 查询退款结果
     *
     * @param bizRefundOrderId 要退款的订单 id
     * @return 退款结果
     */
    @GetMapping("/refund-orders/{bizRefundOrderId}/status")
    RefundResultDTO queryRefundResult(@PathVariable Long bizRefundOrderId);
}
