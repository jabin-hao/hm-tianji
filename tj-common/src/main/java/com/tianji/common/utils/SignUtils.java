...
public class SignUtils {
     ...
     *
     * @param urlPath    访问 uri
     * @param method     访问方法
     * @param queryParam 链接请求参数
     * @param body       请求 body
     * @param expireTime 过期时间 单位ms
     * @param accessKey  加密 access key公开
    ...
    public static String generateToken(String urlPath, String method, String queryParam,
        ...
        try {
            ...
            sbSign.append("|");
            log.debug("signature contents: {}", sbSign);

            MessageDigest md5 = MessageDigest.getInstance("MD5");
            md5.reset();
            md5.update(sbSign.toString().getBytes(StandardCharsets.UTF_8));
     ...
     * 校验 token
     *
     * @param token      来自请求方法的 token
     * @param uri        请求 uri
     * @param method     请求方法
     * @param queryParam 请求参数
     * @param body       请求体
     * @param accessKey  加密 access key，公开
     * @param secretKey  加密串，保密
     * @return 校验结果
     */
