...
public class CourseErrorInfo {
    ...
    public static class Msg {
        ...
        public static final String CATEGORY_DELETE_FAILED = "课程分类删除失败";
        ...
        public static final String COURSE_SAVE_FAILED = "课程基本信息保存失败";
        ...
        public static final String COURSE_CATAS_SAVE_INDEX = "目录的章中有序号是重复的";
        public static final String COURSE_CATAS_SAVE_INDEX_JUMP = "目录的章中有序号不连续";
        ...
        public static final String COURSE_SUBJECT_SAVE_CATALOGUE_ID_NULL = "题目未指定练习 id";
        public static final String COURSE_TEACHER_SAVE_COURSE_ID_NULL = "课程 id 不能为空";
...
//        public static final String COURSE_TEACHER_SAVE_TEACHERS_NUM_MAX = "最多可设置5名课程老师";
        ...
        public static final String COURSE_TEACHER_SAVE_TEACHER_ID_NULL = "老师 id 不能为空";
        ...
        public static final String COURSE_UP_SHELF_ALREADY = "课程已经上架，请勿重复操作";
        public static final String COURSE_DOWN_SHELF_FAILED = "当前课程不能下架";
