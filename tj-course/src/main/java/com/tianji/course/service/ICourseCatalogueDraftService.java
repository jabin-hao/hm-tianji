...
public interface ICourseCatalogueDraftService extends IService<CourseCatalogueDraft> {
    ...
    void saveSubject(Long courseId, List<CataSubjectDTO> cataSubjectDTOS);

    /**
     * 根据课程id，获取题目，用于草稿编辑
     */
    List<CataSimpleSubjectVO> getSubject(Long courseId);
     ...
     * 课程总节和练习数，不包含章
     */
    Long totalSectionNums(Long courseId);
